...
@Component({
  selector: 'app-conflict-devices',
  templateUrl: './conflict-devices.component.html',
  styleUrls: ['./conflict-devices.component.less']
})
export class ConflictDevicesComponent implements OnInit {
